...
//   params,
// }: {
//   // ✅ Next can pass params as a Promise
//   params: { id: string } | Promise<{ id: string }>;
// }) {
//   const { id } = await Promise.resolve(params); // ✅ FIX
...
//                 No matching products found. Make sure looks.json productId matches products.json id
//                 (example: "p1").
//               </div>
//             ) : (
...
//                 const p = product!;
//                 return (
//                   <div key={`${look.id}-${p.id}`} className="bg-white rounded-3xl border border-gray-200 p-4 flex gap-4">
//                     <img
//                       src={p.imageUrl}
//                       alt={p.name}
